...
<div class="right_col" role="main">
  <div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_panel">
        <!------------------------------------------FORM INPUT DATA-------------->
        <form name="formCreateKost" action="{{ route('back.kost.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
          {{ csrf_field() }}
          ...
          <br />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="nama" class="form-control" placeholder="Nama Kost" required="">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <textarea rows="6" class="form-control col-md-7 col-xs-12" id="alamat" type="text" name="alamat" placeholder="Alamat kost" required=""></textarea>
              </div>
            </div>
