            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{ route('back.pemilik.index') }}"><i class="fa fa-home"></i> Pengelolaan Pemilik </a></li>
                  <li><a href="{{ route('back.kost.index') }}"><i class="fa fa-list-ol"></i> Pengelolaan Kost </a></li>
                </ul>
              </div>
